...
def main():
    ...
    ap.add_argument("--retriever", choices=["faiss", "sqlite", "bm25", "hybrid", "splade", "turbovec", "hybrid_splade", "hybrid_turbovec", "hybrid_hyde", "hybrid_all", "hybrid_faiss_turbovec"], default="hybrid")
