...
def main():
    ...
    ap.add_argument("--retriever", choices=["faiss", "sqlite", "bm25", "hyde", "splade", "turbovec", "hyde", "graph", "hybrid_splade", "hybrid_turbovec", "hybrid_hyde", "hybrid_hyde_turbovec", "hybrid_splade_turbovec", "hybrid_hyde_splade_turbovec", "hybrid_all", "hybrid_faiss_turbovec", "hybrid_graph"], default="hybrid")
