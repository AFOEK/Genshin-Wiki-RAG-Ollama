...
class Filters:
    def __init__(self, deny_url_regex: str, deny_text_regex: str, allow_url_regex: str | None = None) -> None:
        ...
        self.allow_url = re.compile(allow_url_regex) if allow_url_regex else None
